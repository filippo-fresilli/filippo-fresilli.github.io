const i18n = {
  it: {
    ...
    ciaobricksLabel: 'App iOS',
    ciaobricksSub:   'Mosaici di mattoncini dalle tue foto',
    expLabel:     'anni di\nesperienza',
    langLabel:    'Lingua',
  },
  fr: {
    ...
    ciaobricksLabel: 'App iOS',
    ciaobricksSub:   'Mosaïques de briques à partir de vos photos',
    expLabel:     'ans\nd\'expérience',
    langLabel:    'Langue',
  },
  en: {
    ...
    ciaobricksLabel: 'iOS App',
    ciaobricksSub:   'Brick mosaics from your photos',
    expLabel:     'years of\nexperience',
    langLabel:    'Language',
  },
}
